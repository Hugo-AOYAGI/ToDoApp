 ...
 * //> 1
 */
var dayOfYear = exports.dayOfYear = function dayOfYear() {
 ...
 * //> 1
 */
var weekNumber = exports.weekNumber = function weekNumber() {
  var date = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new Date();
  ...
  var firstThursday = new Date(thursday.getFullYear(), 0, 1);
 ...
 * //> 1
 */
var weekNumberSun = exports.weekNumberSun = function weekNumberSun() {
  var date = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new Date();
  ...
  // set 1st january first
  var firstSunday = new Date(sunday.getFullYear(), 0, 1);
 ...
 * //> 1
 */
var weekNumberSat = exports.weekNumberSat = function weekNumberSat() {
  var date = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new Date();
  ...
  // set 1st january first
  var firstSaturday = new Date(saturday.getFullYear(), 0, 1);
 ...
 */
var weekNumberYear = exports.weekNumberYear = function weekNumberYear(date) {
  date = new Date(date);
 ...
 * //> { year: 2009, week: 1, day: 1 }
 */
var weekNumberYearSun = exports.weekNumberYearSun = function weekNumberYearSun(date) {
  date = new Date(date);
 ...
 * //> { year: 2009, week: 1, day: 1 }
 */
var weekNumberYearSat = exports.weekNumberYearSat = function weekNumberYearSat(date) {
  date = new Date(date);
